...
import { Link2, Wallet, Building2, User, Mail, Briefcase, FileText, ArrowLeft } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl px-6">
        ...
        <Card className="p-8 bg-card/95 backdrop-blur-xl border-border">
          {/* Header */}
          ...
          <Tabs defaultValue="login" onValueChange={(value) => setIsRegistering(value === "register")}>
            ...
            <TabsContent value="login" className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <Label>Wallet Address de Stacks</Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-10 bg-input-background font-mono"
                    />
                  </div>
                ...
                <Button
                  onClick={handleLogin}
                  className={`w-full ${userType === "employee" ? "bg-gradient-to-r from-[#0E76FD] to-[#6C63FF]" : "bg-gradient-to-r from-[#6C63FF] to-[#8B5CF6]"}`}
                >
            ...
            {userType === "company" && (
              <TabsContent value="register" className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-[#6C63FF] to-[#8B5CF6]"
                >
                  Registrar Empresa
                </Button>
              </TabsContent>
